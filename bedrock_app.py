...
import bedrock_lib as glib #reference to local lib script


st.set_page_config(page_title="GS Foundation Chatbot") #HTML title
st.title("GS Foundation Chatbot") #page title
